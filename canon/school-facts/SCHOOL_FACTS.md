# SCHOOL_FACTS.md — canon (stub v0.1, Principal to complete)

- School: School for Community Development (SCD), **Sylhet** (governed branch).
...
- Roles: Principal (sole ruling authority) · teachers (zero-Git operators) · reviewer-আলিম lane · agents.

⬜ Principal: add academic-calendar facts, staffing facts, and anything agents keep re-asking.
