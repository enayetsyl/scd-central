...
---
**Migration note (step 1):** the 7 MarkLogic files move to canon/marklogic (this workstream
CITES them). This folder keeps: 21 class-subject templates (80-mark halves superseded by
100-mark ruling), 5 gap analyses, term paper production. Fix Rules §6 staleness on slotting.
Reader files stay history-free by design; history lives in Git + CD rows.
