# CORRECTIONS.md — scholarship ledger (append-only, AGENTS.md §6)
...
<!-- ledger-prefix: SCH-CR -->
<!-- ledger-lane: scholarship-corrections -->
...
| ID | Date | Correction | Source | Status (OPEN / PROMOTED / HUMAN-GATE) |
|---|---|---|---|---|
